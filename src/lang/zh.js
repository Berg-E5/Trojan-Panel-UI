export default {
  ...
  table: {
    ...
    daysUnit: '天',
    accounts: '个账号',
    enableConfirm: '确认启用所选账号',
    disableConfirm: '确认禁用所选账号',
    extendConfirm: '确认续期所选账号',
    resetConfirm: '确认重置所选账号流量',
    deleteConfirm: '确认删除所选账号',
    selectActionFirst: '请先选择操作类型',
    selectAccountsFirst: '请先选择要操作的账号',
    confirmTitle: '确认',
