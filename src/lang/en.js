export default {
  ...
  table: {
    ...
    daysUnit: 'days',
    accounts: 'accounts',
    enableConfirm: 'Confirm enabling selected accounts',
    disableConfirm: 'Confirm disabling selected accounts',
    extendConfirm: 'Confirm extending selected accounts',
    resetConfirm: 'Confirm resetting selected accounts traffic',
    deleteConfirm: 'Confirm deleting selected accounts',
    selectActionFirst: 'Please select action type first',
    selectAccountsFirst: 'Please select accounts to operate',
  ...
  stats: {
    ...
    trafficUsageRate: 'Traffic Usage Rate',
    active: 'Active',
    inactive: 'Inactive',
    disabled: 'Disabled',
    online: 'Online',
